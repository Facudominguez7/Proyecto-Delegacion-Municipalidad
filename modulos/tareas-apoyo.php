...
<form action="index.php" method="GET">
    <input type="hidden" name="modulo" value="tareas-apoyo">
...
<div class="flex justify-center mt-10 mb-0">
    <a href="index.php?modulo=agregar-tarea-apoyo">
    ...
    <table class="border-collapse w-full mt-10">
        ...
        <tbody>
            ...
            if (isset($_GET['buscar'])) {
                ...
                $sqlbusqueda = "SELECT *, chacras.nombre AS nombreChacra FROM tareas_apoyo ta INNER JOIN chacras ON ta.idChacra = chacras.id  WHERE chacras.nombre LIKE '$busqueda%' OR ta.titulo LIKE '$busqueda%'";
            ...
            ?>
                ...
                $sqlMostrarChacra = "SELECT ta.id, ta.titulo, ta.idChacra, chacras.nombre AS nombreChacra 
                FROM tareas_apoyo ta 
                INNER JOIN chacras ON ta.idChacra = chacras.id  
