...
if (isset($_GET['accion']) && $_GET['accion'] == 'editar') {
    if (isset($_POST['id']) && isset($_POST['titulo'])) {
        ...
        $sqlEditarDes = "UPDATE tareas_des SET titulo=? WHERE id=?";
        $stmt = mysqli_prepare($con, $sqlEditarDes);
        ...
        if (mysqli_stmt_error($stmt)) {
            ...
            echo "<script>alert('Actividad Actualizada con Éxito');</script>";
        }
        // Cerrar la declaración preparada
        mysqli_stmt_close($stmt);

        // Redirigir de vuelta a la página de detalle de la Punto
        echo "<script>window.location='index.php?modulo=detalle-des&id=". $id ."&idDes=" . $idDes . "';</script>";
    } elseif (isset($_POST['id']) && isset($_POST['fecha'])) {
        $id = $_POST['id'];
        $fecha = $_POST['fecha'];

        $sqlEditarDes = "UPDATE tareas_des SET fecha=? WHERE id=?";
        $stmt = mysqli_prepare($con, $sqlEditarDes);
        ...
        // Redirigir de vuelta a la página de detalle de la Punto
        echo "<script>window.location='index.php?modulo=detalle-des&id=". $id ."&idDes=" . $idDes . "';</script>";
    } elseif ((isset($_POST['id']) && isset($_POST['descripcion']))) {
        $id = $_POST['id'];
        $descripcion = $_POST['descripcion'];

        $sqlEditarDes = "UPDATE tareas_des SET descripcion=? WHERE id=?";
        $stmt = mysqli_prepare($con, $sqlEditarDes);
...
<?php
if (!isset($idDes)) {
    $idDes = isset($_GET['idDes']) ? $_GET['idDes'] : null;
}
?>
<div class="mt-5 ml-60 flex justify-start">
    <a href="index.php?modulo=tareas-des&idDes=<?php echo $idDes ?>">
...
<section class="mt-10">
    <?php
    $id = $_GET['id'];
    $sqlMostrarDetalleDes = "SELECT * FROM tareas_des WHERE id = $id";
    $datos = mysqli_query($con, $sqlMostrarDetalleDes);
    if ($datos->num_rows > 0) {
            ...
            <div class="bg-gray-200">
                <div class="flex items-center justify-center px-4">
                    <div class="max-w-4xl bg-white w-full rounded-lg shadow-xl">
                        <div class="p-4 border-b">
                            <form action="index.php?modulo=detalle-des&accion=editar&idDes=<?php echo $idDes ?>&id=<?php echo $id ?>" method="post" class="w-full">
                                <div class="flex flex-row items-center">
                                    ...
                                    <?php } ?>
                                    <a href="index.php?modulo=detalle-des&id=<?php echo $id ?>&idDes=<?php echo $idDes?>">
                            ...
                            <form class="mt-5 mb-5" action="index.php?modulo=detalle-des&accion=editar&idDes=<?php echo $idDes ?>&id=<?php echo $id ?>" method="post">
                                <div class="flex flex-row items-center">
                        ...
                        <div class="p-4 border-b">
                            <form action="index.php?modulo=detalle-des&accion=editar&idDes=<?php echo $idDes ?>&id=<?php echo $id ?>" method="post">
                ...
                <div class="flex justify-center items-center flex-col mt-5">
                    ...
                    <div class="flex flex-wrap justify-center">
                        <?php
                        $carpetaPunto = "imagenes/tareas_des/" . $fila['id'] . "/";
