...
<div class="mt-5 flex justify-center items-center flex-col md:flex-row md:justify-center">
    <a href="index.php?modulo=tareas&idChacra=<?php echo $_GET['idChacra'] ?>">
        <button class="sm:mb-5 mb-0 middle none center mr-4 rounded-lg bg-gray-800 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-500/20 transition-all hover:shadow-lg hover:shadow-gray-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" data-ripple-light="true">
            Volver
        </button>
    </a>
    <a href="index.php?pdf=ReporteActividadUnica&idTarea=<?php echo $_GET['idTarea']?>" target="_blank">
                        ...
                        <div class="p-4 border-b">
                            <form action="index.php?modulo=detalle&accion=editar&idChacra=<?php echo $_GET['idChacra'] ?>" method="post" class="w-full">
                                <div class="flex flex-row items-center">
                                    ...
                                    <a href="index.php?modulo=detalle&idTarea=<?php echo $idTarea ?>&idChacra=<?php echo $idChacra ?>">
